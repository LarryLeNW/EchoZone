  ...
  return (
    <>
      ...
      {openChats.map((chat, index) => (
        <Card
          key={chat.id}
          className={`fixed bottom-4 z-30 w-80 bg-white dark:bg-gray-800 shadow-2xl border-purple-200 dark:border-purple-700 transition-all duration-300 ${
                      ...
                      >
                        ...
                        <p
                          className={`text-xs mt-1 ${
                            message.isMe ? "text-purple-200" : "text-gray-500 dark:text-gray-400"
                          }`}
                        >
                          {message.time}
                        </p>
