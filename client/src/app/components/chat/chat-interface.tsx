        ...
        <div className="flex-1 overflow-y-auto">
          {filteredChats.map((chat) => (
            <div
              ...
              className={`p-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer ${selectedChat?.id === chat.id ? "bg-gray-100 dark:bg-gray-700" : ""
                }`}
            >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  className={`text-purple-600 hover:text-purple-700 hover:bg-purple-50 dark:hover:bg-purple-900/20 ${showChatInfo ? "bg-purple-50 dark:bg-purple-900/20" : ""
                    }`}
                >
